<div class="col-10 box-right">
    ...
    <div class="head-between">
        <div class="between-container border border-primary">
            ...
            ?>
            <div class="card-form">
                <form action="index.php?act=them-binh-luan" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="">Mã Bình Luận</label>
                            <input type="text" name="ma_bl" id="" placeholder="AUTO" readonly>
                    ...
                    <div class="card-footer">
                        <div class="btn-form">
                            <input class="btn btn-active" type="submit" name="them-bl" value="Tạo mới">
