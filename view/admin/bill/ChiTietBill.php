                    ...
                    <tbody>
                        <?php foreach ($loadMyBill as $myBill) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?act=sua-don-hang&cart=<?= $myBill['id_cart'] ?>" class="btn btn-warning">Sửa</a>
                                    <a href="index.php?act=xoa-don-hang&cart=<?= $myBill['id_cart'] ?>" class="btn btn-danger">Xóa</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
