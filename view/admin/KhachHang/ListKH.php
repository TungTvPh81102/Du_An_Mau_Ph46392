                    ...
                    <tbody>
                        <?php foreach ($loadAllKH as $kh) : ?>
                            <tr>
                                ...
                                <td scope="row"><?= ($kh['vai_tro'] == 1) ? 'Quản trị' : 'Khách hàng' ?></td>
                                <td scope="row"><?= ($kh['kich_hoat'] == 1) ? 'Đã kích hoạt' : 'Chưa kích hoạt' ?></td>
                                <td scope="row"><?= $kh['dia_chi'] ?></td>
                                <td scope="row"><?= $kh['so_dt'] ?></td>
                                <td>
                                    <a href="index.php?act=edit-khach-hang&ma_kh=<?= $kh['ma_kh'] ?>" class="btn btn-warning">Sửa</a>
                                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm không?')" href="index.php?act=xoa-khach-hang&ma_kh=<?= $kh['ma_kh'] ?>" class="
