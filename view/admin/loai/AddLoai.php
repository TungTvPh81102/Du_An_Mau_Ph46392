        ...
        <div class="between-container border border-primary">
            <div class="card-header">
                <div class="card-content">
                    <h5 class="card-tile">Form thêm mới loại hàng</h5>
                </div>
            </div>
            <?php
            ...
            ?>
            <div class="card-form">
                <form action="index.php?act=them-loai-hang" method="post">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="btn-form">
                            <input class="btn btn-active" type="submit" name="them-loai" value="Tạo mới">
